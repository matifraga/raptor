...
public class TweetJDBCTest {
	...
	private static final String UNAME = "user", PASSWORD = "password", EMAIL ="email@email.com", FIRSTNAME ="user", LASTNAME = "user", ID = "12345";
	...
	/*
	@Test
	public void getTweetsByUserIdTest() {
		
		List<Tweet> tweetList = new ArrayList<Tweet>();
	
		tweetList.add(tweetJDBC.create(MESSAGE, user));
		
		assert(tweetList.equals(tweetJDBC.getTweetsByUserID(user.getId(), RESULTSPERPAGE, PAGE)));
