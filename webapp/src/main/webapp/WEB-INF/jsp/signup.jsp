...
<div class="container">
    <div class="col-md-6 col-centered">
        ...
        <form:form role="form" modelAttribute= "signUpForm" action="/signup" method="post">
            ...
            <div class="checkbox">
                <form:label path="terms"><form:checkbox path="terms"/> <spring:message code="label.terms"/></form:label>
            	<form:errors path="terms" cssClass="error"/>
            </div>
            <button type="submit" class="btn btn-raptor pull-right"><spring:message code="label.submit"/></button>
        </form:form>
    </div>
</div>
</body>
